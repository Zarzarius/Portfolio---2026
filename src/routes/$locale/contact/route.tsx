  ...
  return (
    <div className={clsx(styles.container)}>
      <div className={clsx(styles.hero)}>
        ...
        <div className={clsx(styles.contactBlock)}>
          <div className={clsx(styles.contactItem)}>
            <span className={clsx(styles.contactLabel)}>{t.contact.email}</span>
            <a
          ...
          <div className={clsx(styles.contactItem)}>
            <span className={clsx(styles.contactLabel)}>{t.contact.social}</span>
          ...
          <div className={clsx(styles.contactItem)}>
            <span className={clsx(styles.contactLabel)}>{t.contact.phone}</span>
            <a
      ...
      <form className={clsx(styles.form)} onSubmit={handleSubmit}>
        <h2 className={clsx(styles.formHeadline)}>{t.contact.sendMessage}</h2>
