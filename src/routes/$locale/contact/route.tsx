...
function Contact() {
  ...
  return (
    ...
    >
      <div className={`${cx('hero')} pageEntranceItem`}>
      ...
      <div className={`${cx('contactBlock')} pageEntranceItem`}>
      ...
      <form className={`${cx('form')} pageEntranceItem`} onSubmit={handleSubmit}>
